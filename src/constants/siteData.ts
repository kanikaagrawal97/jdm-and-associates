export const SITE_DATA = {
  ...
  services: [
    ...
    {
      category: "Secretarial Audit / Due Diligence Audit",
    ...
    },
    {
      ...
      items: [
        ...
        "Certificate as required for completion of the transfers as required under Clause 40(9) of the Listing Agreement.",
        "Certificate of Non-Disqualification Pursuant to clause (i) of Point (10) of Para C of Schedule V of SEBI (LODR), 2015",
        "Certificate of Corporate Governance Compliance pursuant to Schedule V of SEBi (LODR), 2015",
  ...
  team: [
    ...
    },
    {
      ...
      image: "/images/team/dhaval-master.png",
      description:
        "CS Dhaval P. Master is an Associate Member of the Institute of Company Secretaries of India (ICSI) and a Law and Commerce graduate with 12 years of experience in corporate giants and a decade of practice as a Company Secretary. He has managed compliance for over 400 companies, including listed and Start-up entities. He has in-depth expertise in UK and Indian company law, corporate advisory services, due diligence, internal control, compliance, ERPs, auditing, process optimization, IPO due diligence, Corporate restructuring services, ESG Services, IPR Services, and startups.\nHe has Completed MSc in International Business from Salford University, Manchester (UK) to further enhance corporate governance and compliance expertise, along with business acumen and strategic mindset.\n\nHe is responsible for overseeing and managing major client engagements at the Head Office (Surat), ensuring high-quality service delivery, regulatory adherence, and effective client relationship management.",
    },
    {
      name: "CS Ekta Kansal",
      ...
      role: "Partner",
      qualification: "B. Com, ACS",
      image: "/images/team/ekta-kansal.png",
      description:
        "CS Ekta Kansal is an Associate Member of the Institute of Company Secretaries of India (ICSI). With a distinguished four-year post-qualification experience, she has developed deep expertise in the domain of Corporate Laws, regulatory Compliance, and governance frameworks. Her professional experience spans a wide range of regulatory and transactional matters, including Company Incorporation, private placements, change of state, Rights Issues, Annual Filings, FEMA compliances, Merger & Amalgamations and allied Secretarial functions.\n\nShe leads and executes Secretarial Audits and Due Diligence Audits, involving comprehensive review of statutory records, assessment of regulatory compliance frameworks, identification of gaps, and providing actionable recommendations to ensure robust corporate governance and risk mitigation.\n\nShe is responsible for managing and servicing key client engagements for the Mumbai region, ensuring timely compliance, efficient execution, and high-quality professional delivery.",
    },
    {
      ...
      qualification: "B. Com, ACS",
      image: "/images/team/vaibhavi-jhaveri.png",
      description:
        "CS Vaibhavi Jhaveri is an Associate Member of the Institute of Company Secretaries of India (ICSI) with over 11 years of extensive exposure of Secretarial Practices and Company Law compliances. She demonstrates strong expertise in ensuring adherence to statutory and regulatory frameworks applicable to Companies and LLP’s. She possesses in-depth knowledge of Companies Act compliances, LLP Act compliances, secretarial compliances and regulatory reporting. Experienced in incorporation, capital infusion process, annual filings, due diligence, maintenance of minutes statutory registers, LEI Certification, FLA Returns and closures of Companies and LLP.\n\nShe has also worked in Scottish Corporate Insolvency and Business Recovery as per UK laws and other diversified fields. Having proven ability to oversee end-to-end compliance management.",
    },
    {
    ...
    },
    {
      ...
      qualification: "B.Com, ACS",
      image: "/images/team/mukti-shah.png",
      description:
    ...
    },
    {
      ...
      role: "Associate Manager – Secretarial",
      qualification: "B. Com, ACS",
      image: "/images/team/daya-savani.png",
      description:
    ...
    },
    {
      ...
      qualification: "B.Com, ACS",
      image: "/images/team/deepika-jain.png",
      description:
    ...
    },
    {
      ...
      description:
        "Meghna Chauhan is a key member of the Secretarial team, with primary expertise in handling Limited Liability Partnership (“LLP”) compliances and regulatory matters. She has developed strong practical experience in managing end-to-end LLP compliance requirements in accordance with the provisions of the LLP Act, 2008 and allied rules.\n\nIn addition, she has hands-on experience in maintaining statutory records, ensuring ROC filings, and handling XBRL-based filings, wherever applicable, along with advising on ongoing compliance requirements for LLPs across various industries. Her role also involves close coordination with clients and regulatory authorities to ensure smooth and timely execution of compliance procedures.",
    },
    {
      name: "Article Assistants & Interns",
      role: "",
      image: "/images/team/articled-assistants.png",
      description:
  ...
  contact: {
    ...
    phones: [{ number: "+91 9510827803" }, { number: "+91 81285 98731" }],
    ...
    offices: [
      {
        ...
        phone: "+91 9879394866",
        contactPerson: "CS Dhaval P. Master",
        mapEmbedUrl:
      ...
      },
      {
        ...
        phone: "+91 9799661616",
        contactPerson: "CS Jaisal Mohatta",
        mapEmbedUrl:
  ...
  clients: [
    {
      name: "MAITREYA MEDICARE LIMITED",
      industry: "Healthcare",
      logo: "/images/clients/MAITREYA.png",
    },
    {
      name: "FOCUS BUSINESS SOLUTION LIMITED",
      industry: "Business Solutions",
      logo: "/images/clients/focus-business-solution-limite--600.png",
    },
    {
    ...
    {
      name: "VAAMAN ENGINEERS (INDIA) LIMITED",
      industry: "Engineering",
      logo: "/images/clients/vaaman.jpeg",
    },
    {
      name: "SAHARA HOSPITALITY LIMITED",
      industry: "Hospitality",
      logo: "/images/clients/sahara star.png",
    },

    {
      name: "KAAVERI STEELS (I) PRIVATE LIMITED",
      industry: "Steel Manufacturing",
      logo: "/images/clients/kaveri.png",
    },
    {
      name: "FAILTE ENERGY SOLUTIONS INDIA PRIVATE LIMITED",
      industry: "Renewable Energy",
      logo: "/images/clients/failtesolar.jpg",
    },

    {
      name: "SERVOTECH INDIA LIMITED",
      industry: "Technology",
      logo: "/images/clients/servotech_india_ltd__logo.jpeg",
    },
    {
      name: "WEAVETECH ENGINEERS LIMITED",
      industry: "Engineering",
      logo: "/images/clients/weavetech.jpg",
    },

    {
      name: "KOMBEE TECHNOLOGIES (I) PRIVATE LIMITED",
      industry: "Technology",
      logo: "/images/clients/kombee_global_logo.jpeg",
    },
    {
      name: "PROLITE AUTOGLO LIMITED",
      industry: "Manufacturing",
      logo: "/images/clients/prolite-autoglo-limited-logo-120x120.jpg",
    },
    {
      name: "RASIK VATIKA GROUP",
      industry: "Manufacturing",
    ...
    {
      name: "KALEEN LIFESTYLE PRIVATE LIMITED",
      industry: "Lifestyle",
      initials: "KLPL",
    },
    { name: "PRAJAKT GROUP", industry: "Corporate", initials: "PG" },
    {
      name: "PRIYANKA PROCESSORS PRIVATE LIMITED",
      industry: "Manufacturing",
      initials: "PPPL",
    },
    {
      name: "THIRUPATHI STEELS PRIVATE LIMITED",
      industry: "Steel Manufacturing",
      initials: "TSPL",
    },
    {
  ...
  policies: [
    {
      title: "Introduction",
      content: `JDM and Associates LLP ("we," "us," or "our") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your personal information when you visit our website or engage our services as Corporate Governance & Compliance Consultants.`,
    },
    {
      title: "Information We Collect",
      content:
        "We may collect personal information such as your name, email address, phone number, and professional details when you fill out contact forms, subscribe to our newsletters, or engage in professional consultations. We also collect non-personal data through cookies to improve website performance.",
    },
    {
    ...
    - Send relevant regulatory updates and newsletters.
    - Comply with legal and statutory requirements under the Companies Act and other applicable laws.`,
    },
    {
      title: "Data Security",
      content:
        "We implement robust technical and organizational measures to protect your data against unauthorized access, loss, or misuse. Our systems are equipped with advanced compliance software to ensure data integrity.",
    },
    {
      title: "Third-Party Disclosure",
      content:
        "We do not sell or trade your personal information. We may share data with trusted third-party service providers who assist us in operating our website or conducting our business, provided they agree to keep this information confidential.",
    },
    {
      title: "Your Rights",
      content:
        "You have the right to access, correct, or request the deletion of your personal information held by us. To exercise these rights, please contact our compliance officer at the details provided below.",
    },
    {
  ...
  terms: [
    {
      ...
      content:
        "By accessing and using this website, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service. If you do not agree, you should not access its contents.",
    },
    {
      title: "Description of Service",
      content:
        "JDM and Associates LLP provides professional Corporate Secretarial services, including corporate compliance management, due diligence, and regulatory reporting. Our services are as provided and subject to professional ethics and legal standards.",
    },
    {
      title: "User Conduct",
      content:
        "Users agree to engage with our website and services in a lawful manner. Any unauthorized use or disruption of the website is strictly prohibited. Information provided through our contact forms must be accurate.",
    },
    {
      title: "Intellectual Property",
      content:
        "All content on this website, including text, logos, designs, and graphics, is the intellectual property of JDM and Associates LLP and is protected by copyright laws. No part of this site may be reproduced without prior written permission.",
    },
    {
      title: "Limitation of Liability",
      content:
        "While we strive for accuracy, JDM and Associates LLP is not liable for any direct, indirect, or consequential damages arising from the use or inability to use the website content or our services. Professional advice should be sought for specific legal matters.",
    },
    {
      title: "Governing Law",
      content:
        "These terms are governed by the laws of India. Any disputes arising from the use of this website shall be subject to the exclusive jurisdiction of the courts in Surat, Gujarat.",
    },
    {
      title: "Changes to Terms",
      content:
        "We reserve the right to modify these Terms of Service at any time. Changes will be effective immediately upon posting. Your continued use of the website constitutes acceptance of the new terms.",
    },
  ],
